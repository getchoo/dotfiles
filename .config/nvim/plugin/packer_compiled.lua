...
_G.packer_plugins = {
  ...
  ["barbar.nvim"] = {
    loaded = true,
    path = "/home/seth/.local/share/nvim/site/pack/packer/start/barbar.nvim",
  ...
  ["editorconfig-vim"] = {
    loaded = true,
    path = "/home/seth/.local/share/nvim/site/pack/packer/start/editorconfig-vim",
  ...
  ["lightspeed.nvim"] = {
    loaded = true,
    path = "/home/seth/.local/share/nvim/site/pack/packer/start/lightspeed.nvim",
  ...
  ["nord.nvim"] = {
    loaded = true,
    path = "/home/seth/.local/share/nvim/site/pack/packer/start/nord.nvim",
  ...
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/home/seth/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
